...
// These are NOT SAVED with the project
	...
	var _UI = {
		...
		"thisGlyphrStudioVersion" : "Beta 3.2 - 0.3.2.sandbox",
		"projectsaved": true,
		"colors" : {
...
var sandboxfont = {
	"projectsettings": {
		"name": "Modegg",
		"debug": true,
		"version": "Beta 3 Working Edition - 0.3.2014.1.00.Working",
		"linkedshapecounter": 7,
		"upm": 1000,
		"ascent": 700,
		"linegap": 250,
		"griddivisions": 10,
		...
		"quickpathupdating": false,
		"showoutline": false,
		"showfill": true,
		"color_glyphfill": "rgb(0,0,0)",
		"color_glyphoutline": "rgb(0,0,0)",
		"color_grid": "rgb(240,240,240)",
		"color_guideline": "rgb(204,79,34)"
	},
	"fontchars": [
		null,
		null,
		...
		},
		{
			...
			"charshapes": [
				{
					"objtype": "linkedshapeinstance",
					"link": "id0",
					"uselinkedshapexy": true,
					"name": "new linkedshape instance",
					"xpos": 100,
					"ypos": 100,
					"xlock": false,
					"ylock": false,
	...
	"opentypeproperties": {
		...
		"name": [
			...
			{
				"key": "Font Subfamily name",
				"val": ""
			},
			{
				"key": "Unique font identifier",
				"val": "Modegg 1.0"
			},
			{
				"key": "Full Font name",
			...
			},
			{
				...
				"val": "Creative Commons Attribution-ShareAlike 3.0 Unported (CC BY-SA 3.0)"
			},
			{
				"key": "License URL",
				"val": "http://creativecommons.org/licenses/by-sa/3.0/"
			}
		],
		"post": [
			{
	...
	function setup() {
		...
		drawLogo();
		hydrateGlyphrProject(sandboxfont);
